...
public class PruebaAudioVisual { 
	public static void main(String[] args) { //punto de inicio del programa
        System.out.println("Hello from Eclipse!");//primer mensaje del programa
        ...
        ContenidoAudiovisual[] contenidos = new ContenidoAudiovisual[5];//se crea el arreglo contenidos, que guarda varios datos del mismo tipo, en este caso guarda 3 datos
